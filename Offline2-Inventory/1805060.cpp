...
int amount, bigs, I, inv_level, next_event_type, num_events,
    N, D, smalls;
...
void report(void) /* Report generator function. */
{
    ...
    outfile << "\n\n(" << smalls << "," << std::setw(3) << std::setfill(' ') << bigs << ")" << "            " << std::setw(8) << std::setfill(' ') << avg_ordering_cost + avg_holding_cost + avg_shortage_cost
            << "            " << std::setw(8) << std::setfill(' ') << avg_ordering_cost << "            " << std::setw(8) << std::setfill(' ') << avg_holding_cost << "            " << std::setw(8) << std::setfill(' ') << avg_shortage_cost;
}
